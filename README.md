...
Partly generated by Github copilot


# Calculator for Raspberry Pi Pico / 适用于树莓派Pico的计算器

This project aims to be a powerful and feature-rich scientific and graphical calculator for the Raspberry Pi Pico microcontroller—far surpassing most commercial scientific and graphical calculators in both capability and flexibility. 

本项目致力于打造功能强大、特性丰富的树莓派Pico科学与图形计算器。

### Features | 功能
- Advanced scientific and graphical calculation / CAS (in progress)
- Modular, extensible codebase
- Full support for ST7735 color display (required)
- Custom font and UI rendering
- Designed for Raspberry Pi Pico
- Roadmap: graphing, programmability, symbolic math, and more
