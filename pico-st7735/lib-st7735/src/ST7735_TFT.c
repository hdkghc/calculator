...
// Additional init function for 1.8" ST7735S displays

#if defined TFT_ENABLE_ST7735S


// ST7735S Display Initialization

void TFT_ST7735S_Initialize(void) {
#if defined TFT_ENABLE_RESET
    TFT_ResetPIN();
#endif
    tft_dc_low();
    ...
    // Set column and row start for 1.8" ST7735S displays
    _colstart = 1;
    _rowstart = 2;
    _tft_type = 0;
}
